...
while($row = mysqli_fetch_assoc($query))
{
	...
	$sub_array[] = '<a href="javascript:void();" data-id="'.$row['id'].'" class="btn btn-info btn-sm editissuancebtn" ><i class="fas fa-edit"></i></a>  
					<a href="javascript:void();" data-id="'.$row['id'].'" data-tracking_number="'.$row['tracking_number'].'"
					class="btn btn-danger btn-sm deleteBtn_issuances" ><i class="fas fa-trash"></i></a>';
	$sub_array[] = $row['id'];
